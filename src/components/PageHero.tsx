        ...
        {!hideCtas && (
          <div className="hero-cta-group flex flex-row justify-center items-center gap-2 sm:gap-4 w-full sm:w-auto max-w-sm sm:max-w-none mx-auto">
            {isAnchorOrTel(primary.href) ? (
              <a
                href={primary.href}
                className="bg-white text-blue-950 px-2 sm:px-8 py-1.5 sm:py-3.5 rounded-md font-bold text-xs sm:text-base hover:bg-slate-100 transition-colors flex-1 sm:flex-initial sm:w-auto shadow-lg flex items-center justify-center gap-1.5 sm:gap-2 h-10 sm:h-12 flex-shrink-0 text-center [&>svg]:w-3.5 [&>svg]:h-3.5 sm:[&>svg]:w-5 sm:[&>svg]:h-5"
              >
            ...
            {isAnchorOrTel(secondary.href) ? (
              <a
                href={secondary.href}
                className="bg-white/5 backdrop-blur-[2px] border border-white/20 text-white px-2 sm:px-8 py-1.5 sm:py-3.5 rounded-md font-bold text-xs sm:text-base hover:bg-white/10 transition-colors flex-1 sm:flex-initial sm:w-auto flex items-center justify-center gap-1.5 sm:gap-2 h-10 sm:h-12 flex-shrink-0 text-center [&>svg]:w-3.5 [&>svg]:h-3.5 sm:[&>svg]:w-5 sm:[&>svg]:h-5"
              >
