  ...
  return (
    <div className="bg-slate-50 min-h-screen text-slate-800">
      <SEO
        ...
        description="Multi-zone ductless mini split heat pump installation and repair in San Jose & Bay Area. High-efficiency zoned cooling & heating. Call (408) 320-3288."
